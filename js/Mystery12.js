class Mystery12 extends Dialog {
  /**
   * constructor
  ...
  constructor(selector) {
      console.log('[mystery12] constructor ');
      super(selector);
...
onStart(e) {
  ...
  if (nextOpenState) {
    this.nazoDialog.classList.add('mystery12');
  } else {
    this.nazoDialog.classList.remove('mystery12');
  }
...
onReadRFID(e) {
  ...
  if (this.isOpen) {
    console.log('[mystery12] onReadRFID', e);
